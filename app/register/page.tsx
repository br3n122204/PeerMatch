  ...
  return (
    <div className="min-h-screen bg-[#E5F6F4] px-4 py-10">
      <div className="mx-auto flex w-full max-w-5xl flex-col items-center gap-10">
        <div className="flex w-full max-w-xl items-center justify-center rounded-full bg-white/90 px-6 py-4 shadow-[0_16px_60px_rgba(0,0,0,0.08)]">
        ...
        <div className="w-full max-w-xl rounded-[2.5rem] bg-white px-10 py-10 shadow-[0_30px_90px_rgba(0,0,0,0.14)]">
          <h1 className="text-3xl font-semibold text-[#0F172A]">Sign up as a Client</h1>
          <form onSubmit={handleSubmit} className="mt-8 space-y-5">
            ...
            <div className="flex items-start gap-3 rounded-3xl border border-zinc-200 bg-[#F8FAFC] p-4">
              <label className="flex items-center gap-3 text-sm text-zinc-700">
                ...
                <span>
                  ...
                  <a href="#" className="font-semibold text-[#0069A8] hover:text-[#004f7d]">
                    Terms of Services
                  </a>
                </span>
              </label>
            ...
            <button
              type="submit"
              className="w-full rounded-3xl bg-[#FA642C] py-4 text-sm font-semibold text-white shadow-[0_20px_40px_rgba(250,100,44,0.22)] transition hover:bg-[#e05625]"
            >
              Create account
            </button>
          </form>
